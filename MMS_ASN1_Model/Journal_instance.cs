...
namespace MMS_ASN1_Model {
	...
	private System.Collections.Generic.ICollection<Journal_Entry_instance> entries_ ;
	
[ASN1SequenceOf( Name = "entries", IsSetOf = false  )]

    
        [ASN1ElementAtr ( Name = "entries", IsOptional =  false , HasTag =  true, Tag = 4 , HasDefaultValue =  false )  ]
    
        public System.Collections.Generic.ICollection<Journal_Entry_instance> Entries
        {
            get { return entries_; }
            set { entries_ = value;  }
        }
        ...
        public DefinitionChoiceType Definition
        {
            ...
            private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(Journal_instance));
            public IASN1PreparedElementData PreparedData {
            	get { return preparedData; }
            }
